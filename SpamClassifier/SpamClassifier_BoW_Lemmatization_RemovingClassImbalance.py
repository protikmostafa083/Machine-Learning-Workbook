# -*- coding: utf-8 -*-
"""
Created on Tue Sep 14 23:53:45 2021
...
'''
Removing Class Imbalance + BoW + Lemmatization
...
messages = pd.read_csv('/content/data/SMSSpamCollection', sep='\t', names=['label', 'message'])
...
for i in range(0, len(messages)):
    ...
    sents = sents.lower()
    sents = sents.split()
    sents = [stemmer.lemmatize(word) for word in sents if word not in set(stopwords.words('english'))]
    sents = ' '.join(sents)
